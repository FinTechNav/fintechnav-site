  ...
  return (
    <section className="section fade-in" style={styles.section}>
      <div style={styles.sectionContent}>
        ...
        <p style={styles.p}>
          Over the past 25+ years, I've been fortunate to work with some incredible companies and
          even more incredible people. What follows is my journey through both the technology and
          payment industries - a path shaped by professional relationships and some interesting
          transitions:
        </p>
      </div>
                  ...
                  >
                    ...
                    <h3 style={styles.h3}>
                      <a
                        ...
                        style={{
                          ...styles.companyLink,
                          ...(hoveredItem === `companyLeft-${index}`
                            ? styles.companyLinkHover
                            : {}),
                        }}
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            ...(hoveredItem === `companyLeft-${index}`
                              ? styles.companyLinkArrowVisible
                              : {}),
                          }}
                        >
                          ↗
                    ...
                    {item.conclusion && <p style={styles.contentText}>{item.conclusion}</p>}
                  </div>
                </div>
                  ...
                  >
                    ...
                    <h3 style={styles.h3}>
                      <a
                        ...
                        style={{
                          ...styles.companyLink,
                          ...(hoveredItem === `companyRight-${index}`
                            ? styles.companyLinkHover
                            : {}),
                        }}
                ...
                <h3 style={styles.h3}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...styles.companyLinkArrow,
                        ...(hoveredItem === `companyMobile-${index}`
                          ? styles.companyLinkArrowVisible
                          : {}),
                      }}
                    >
